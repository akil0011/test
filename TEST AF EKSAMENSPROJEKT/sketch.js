...
function knap16() {
  ...
  button3.size(((windowWidth / 4) * 2) / 3, (windowHeight / 2) * 0.39 - 5);
  ...
  button5.size(((windowWidth / 4) * 2) / 3, (windowHeight / 2) * 0.39 - 5);
...
function drawtekst() {
  ...
  if (mouseIsPressed && mouseX < width && mouseY < height) {
    if (mouseX < width / 2) {
      ...
      if (buttons.indexOf(chosenButton) === 5) {
        fill(255, 0, 0);
...
function mousePressed() {
  ...
  } else if (visMenu === false && shot === undefined) {
    shot = false;
  } else if (shot === false) {
    x = windowWidth / 2;
    y = windowHeight - 150;
...
function drawRectangles() {
  ...
  rect(
    ...
    (windowHeight / 2) * 0.2,
    (2 * windowWidth) / 4 / 3,
    (windowHeight / 2) * 0.9 - (windowHeight / 2) * 0.2
  );
  rect(
    windowWidth / 4 + (2 * windowWidth) / 4 / 3,
    (windowHeight / 2) * 0.2,
    (2 * windowWidth) / 4 / 3,
    (windowHeight / 2) * 0.9 - (windowHeight / 2) * 0.2
  );
  rect(
    windowWidth / 4 + (2 * ((2 * windowWidth) / 4)) / 3,
    (windowHeight / 2) * 0.2,
    (2 * windowWidth) / 4 / 3,
    (windowHeight / 2) * 0.9 - (windowHeight / 2) * 0.2
  );
